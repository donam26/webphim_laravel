                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ isset($genre) ? $genre->title : '' }}" name="title"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ isset($genre) ? $genre->description : '' }}" name="description"
                                class="form-control" id="exampleInputPassword1" placeholder="Nhập mô tả">
                        </div>
                        <div class="form-group">
                            Kích hoạt
                            <div class="form-check">
                                <input id="rd-check" class="form-check-input" type="radio" name="status" value="1"
                                    @if (isset($genre)) {{ $genre->status == 1 ? 'checked=""' : '' }} @else {!! 'checked=""' !!}> @endif
                            ...
                            <div class="form-check">
                                <input id="rd-check2" class="form-check-input" type="radio" name="status" value="0"
                                    @if (isset($genre)) {{ $genre->status == 0 ? 'checked=""' : '' }}> @endif
                            ...
                            <tr>
                                ...
                                <td class="col-3">
                                    <form class="d-inline-block" method="POST"
                                        action="{{ route('genre.destroy', $list->id) }}"
                                        onsubmit="return confirm('Xóa ?')">
                                        @method('DELETE')
                                        @csrf
                                        <input type="submit" value="Xóa" class="btn btn-danger">
                                    </form>
                                    <a class="btn btn-primary" href="{{ route('genre.edit', $list->id) }}">Sửa</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
